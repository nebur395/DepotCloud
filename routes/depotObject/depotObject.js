...
module.exports = function (app) {
     ...
     *     responses:
     *       200:
     *         description: Lista con todos los objetos de la unidad familiar.
     *         schema:
     *           type: object
     *           properties:
     *              depotObjects:
    ...
    /**
     * @swagger
     * /depotObjects/search/{owner}/{name}:
     *   get:
     *     tags:
     *       - DepotObject
     *     summary: Buscar objetos.
     *     description: Busca todos los objetos pertenecientes a {owner} que contengan la
     *       palabra {name} (siendo una búsqueda case-insensitive).
     *     consumes:
     *       - application/json
     *       - charset=utf-8
     *     produces:
     ...
     *         format: byte
     *       - name: owner
     *         description: Email al que pertenecen los objetos que se desean buscar.
     *         in: path
     *         required: true
     *         type: string
     *       - name: name
     *         description: String que está contenido en los objetos que se desean buscar
     *           (case-insensitive).
     *         in: path
     *         required: true
     *         type: string
     ...
     *           $ref: '#/definitions/FeedbackMessage'
     */
    router.get("/search/:owner/:name", function (req, res) {
