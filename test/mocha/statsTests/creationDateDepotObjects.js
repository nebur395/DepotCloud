...
describe('Stats', function () {
    ...
    /**
     * Tests for creationDateDepotObjects stat.
     */
    describe("#creationDateDepotObjects()", function () {

        it('should successfully get the creationDateDepotObjects stats', function (done) {
            ...
            chai.request(server)
                ...
                .end(function (err, result) {
                    ...
                    result.body.should.have.property('creationDateDepotObjects');
