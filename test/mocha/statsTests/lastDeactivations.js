...
describe('Stats', function () {
    ...
    /**
     * Tests for lastDeactivations stat.
     */
    describe("#lastDeactivations()", function () {

        it('should successfully get the lastDeactivations stats', function (done) {
            ...
            chai.request(server)
                ...
                .end(function (err, result) {
                    ...
                    result.body.should.have.property('lastDeactivations');
