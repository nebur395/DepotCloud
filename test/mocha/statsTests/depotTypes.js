...
describe('Stats', function () {
                ...
                "Depot Description", depotsId, function () {
                    ...
                    createDepot("Depot name", email, "Depot Location", "House", "[0-1km]",
                        "Depot Description", depotsId, function () {
                            ...
                            createDepot("Depot name", email, "Depot Location", "Wardrobe", "[0-1km]",
    ...
    /**
     * Tests for depotTypes stat.
     */
    describe("#depotTypes()", function () {

        it('should successfully get the depotTypes stats', function (done) {
            ...
            chai.request(server)
                ...
                .end(function (err, result) {
                    ...
                    result.body.should.have.property('storageRooms');
                    result.body.should.have.property('houses');
                    result.body.should.have.property('wardrobes');
