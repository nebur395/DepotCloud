...
describe('Stats', function () {
    ...
    /**
     * Tests for totalDepots stat.
     */
    describe("#totalUsers()", function () {

        it('should successfully get the totalDepots stats', function (done) {
            ...
            chai.request(server)
                ...
                .end(function (err, result) {
                    ...
                    result.body.should.have.property('totalDepots');
