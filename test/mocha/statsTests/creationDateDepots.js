...
describe('Stats', function () {
    ...
    /**
     * Tests for creationDateDepots stat.
     */
    describe("#creationDateDepots()", function () {

        it('should successfully get the creationDateDepots stats', function (done) {
            ...
            chai.request(server)
                ...
                .end(function (err, result) {
                    ...
                    result.body.should.have.property('creationDateDepots');
